...
public class JavaEmbeddedNeo4j {
	...
	private static final Path databaseDirectory = Paths.get("target/JavaDB_Test");
...
//	}
	...
	public static void main(final String[] args) throws IOException {
		...
		hello.loadXmi("model/eclipseModel-0.1.xmi");
		//hello.printInfo();
		hello.createDb();
	...
	//	registerShutdownHook(managementService);
		...
		try (Transaction tx = graphDb.beginTx()) {
			...
			//	printGraph();
			//	System.out.println("Size Objs: " + objects.size());
