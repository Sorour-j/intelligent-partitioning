...
public class EffectiveResultSetListSelectOperation extends SelectOperation {
	...
	public Collection<?> execute(boolean returnOnMatch, Object target, NameExpression operationNameExpression,
		...
		EffectiveResultSetList list = (EffectiveResultSetList) target;
		...
		return new EffectiveResultSetList((EmfMySqlModel)list.getModel(), list.getTable(), selectCondition, selectParameters, list.isStreamed(), returnOnMatch);
	}
}
